...
public class IrisClassifierNewTrained {

	private static Map<Integer, String> classifiers;

	public IrisClassifierNewTrained() {
	...
	public void classify(String irisDataTrainFile, String irisDataTestFile)
		...
		MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder().seed(seed).iterations(iterations)
				.activation(Activation.TANH).weightInit(WeightInit.XAVIER).learningRate(0.01).regularization(true)

...
public class HelloWorld {
	...
	public static void run() {
		...
		CollisionShape groundShape = new BoxShape(new Vector3(50.f, 50.f, 50.f));
		...
		groundTransform.origin.set(new Vector3(0.f, -56.f, 0.f));
...

		{
			...
			startTransform.origin.set(new Vector3(2, 10, 0));

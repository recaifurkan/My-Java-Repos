...
public class CameraController {
	...
	private final Vector3 worldGroundTarget = new Vector3(0,0,0);
	// Temporary
...
//			worldGroundTarget.set(tmp2);
		...
		camera.position.set(camera.position.x,camera.position.y,camera.position.z + Gdx.graphics.getDeltaTime());
		camera.update();
	}

...
package com.byrfb.characters.objectmodels;
...
public class GameModel extends GameObject {
	...
	public GameModel(Model model,
		...
		setTransform(location, rotation, scale, modelInstance);
	...
	public static void setTransform(Vector3 location, Vector3 rotation, Vector3 scale,
